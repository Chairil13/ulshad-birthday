$('.start').click(function(){
    $('.stage1').fadeOut();
    fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/cake_modal.png','Let’s make a cake!','Karena ini hari ulang tahunmu dan tentu saja itu spesial untukmu, aku merasa jika kita harus membuat kue ulang tahun untuk merayakan nya, walau cuma digital tapi kuharap kamu suka hehe... Mulailah dengan membuat campuran kue, lalu panggang dalam oven digital dan terakhir menghiasnya, selamat bersenang-senang dan selamat ulang tahun Ulshad :)');
})
...
$('.mixer').click(function(){
    ...
    if(mixtimes == 2){
        $('.stage2').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/mix_modal.png','Yeeeyy, berhasil mencampur','Selamat Ulshad, campurannya sempurna! selanjutnya setelah adonan dituang ke dalam loyang, sekarang memasukkannya ke dalam oven digital selama sekitar 3 detik, anggap aja itu waktu yang cukup untuk hasil yang bagus hehe.');
    }
...
$( ".oven" ).droppable({
    drop: function( event, ui ) {
        $('.stage3').fadeOut();
        fire_modal('https://s3-us-west-2.amazonaws.com/s.cdpn.io/217233/oven_modal.png','Berhasil memanggangll!','Mantaaapp jiwa. Dasar adonan nya benar-benar matang dan terlihat sangat lezat. Sekarang saatnya menggabungkan bahan dasar ini dengan banyak bahan lain seperti selai, cokelat, krim dan banyak lagi.');
    }
})
